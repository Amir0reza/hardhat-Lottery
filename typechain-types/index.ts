...
export type { LotteryTokenClassic } from "./contracts/Token.sol/LotteryTokenClassic";
export { LotteryTokenClassic__factory } from "./factories/contracts/Token.sol/LotteryTokenClassic__factory";
